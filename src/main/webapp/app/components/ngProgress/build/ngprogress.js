    ...
    .service('ngProgress', function () {
        'use strict';
            ...
            this.intervalCounterId = 0;
                ...
                // to hide it
                this.start = function () {
                    $('#ngProgress-container').css('display', 'block')
                ...
                this.hide = function() {
                    $('#ngProgress-container').css('display', 'none')
...
angular.module('ngProgress.directive', [])
    .directive('ngProgress', ["$window", "$rootScope", function ($window, $rootScope) {
        var directiveObj = {
            ...
            template: '<div id="ngProgress-container"><div id="ngProgress">' +
            '<div id="loading-bar-spinner"><div class="spinner-icon" style="  position:absolute;      top:50%;      left:50%;  width: 50px; height: 50px;    margin:-25px 0 0 -25px;"></div></div>' +
            '</div></div>'
        };
        return directiveObj;
    }]);
