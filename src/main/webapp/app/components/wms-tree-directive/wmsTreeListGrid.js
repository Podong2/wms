...
(function() {
    ...
    angular.module('wmsApp')
        .directive('wmsTreeListGrid', wmsTreeListGrid);

    wmsTreeListGrid.$inject = ['$log'];

    function wmsTreeListGrid($log) {
        ...
        return {
            ...
            replace: false,
            templateUrl: 'app/components/wms-tree-directive/wmsTreeListGrid.html',
