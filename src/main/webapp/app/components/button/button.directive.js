    ...
    function owlBtnFind(btnService) {
        return {
            ...
            compile: function (tElement, tAttrs) {
                var btnName = "find";
                var btnClass = "btn btn_icon btn_cons2 btn-sm btn-radius";
...
owlBtnNext.$inject=['btnService'];
    function owlBtnNext(btnService) {
        return {
            ...
            compile: function (tElement, tAttrs) {
                var btnName = "next";
                var btnClass = "btn btn_submit btn_customs3 btn-sm btn-radius";
    ...
    function owlBtnDownload(btnService) {
        return {
            ...
            compile: function (tElement, tAttrs) {
                ...
                var btnClass = "btn btn_icon btn_color3 btn-sm btn-radius";
...
owlBtnRemove.$inject=['btnService'];
    function owlBtnRemove(btnService) {
        return {
            ...
            compile: function (tElement, tAttrs) {
                var btnName = "remove";
                var btnClass = "btn btn_icon btn_color4 btn-sm btn-danger btn-radius";
...
owlBtnAdd.$inject=['btnService'];
    function owlBtnAdd(btnService) {
        return {
            ...
            compile: function (tElement, tAttrs) {
                var btnName = "add";
                var btnClass = "btn btn_icon btn-sm btn-sm btn-radius";
...
owlBtnDelete.$inject=['btnService'];
    function owlBtnDelete(btnService) {
        return {
            ...
            compile: function (tElement, tAttrs) {
                var btnName = "delete";
                var btnClass = "btn btn_icon btn_color1_3 btn-sm btn-radius";
    ...
    function owlBtnStateChange(btnService) {
        return {
            ...
            compile: function (tElement, tAttrs) {
                ...
                var btnClass = "btn btn_icon btn_color5 btn-sm btn-radius";
...
owlBtnList.$inject=['btnService'];
    function owlBtnList(btnService) {
        return {
            ...
            compile: function (tElement, tAttrs) {
                var btnName = "list";
                var btnClass = "btn btn_iconT btn_color5 btn-sm btn-radius";
...
owlBtnDetail.$inject=['btnService'];
    function owlBtnDetail(btnService) {
        return {
            ...
            compile: function (tElement, tAttrs) {
                var btnName = "detail";
                var btnClass = "btn btn_iconT btn_cons btn-sm btn-radius";
...
owlBtnSave.$inject=['btnService'];
    function owlBtnSave(btnService) {
        return {
            ...
            compile: function (tElement, tAttrs) {
                var btnName = "save";
                var btnClass = "btn btn-submit btn_customs btn-sm btn-radius";
    ...
    function owlBtnPositionSave(btnService) {
        return {
            ...
            compile: function (tElement, tAttrs) {
                ...
                var btnClass = "btn btn_icon btn_color8 btn-sm btn-radius";
...
owlBtnCancel.$inject=['btnService'];
    function owlBtnCancel(btnService) {
        return {
            ...
            compile: function (tElement, tAttrs) {
                var btnName = "cancel";
                var btnClass = "btn btn-submit btn_customs2 btn-sm btn-radius";
...
owlBtnEtcFunc.$inject=['btnService'];
     function owlBtnEtcFunc(btnService) {
        return {
            ...
            compile: function (tElement, tAttrs) {
                var btnName = "etcFunc";
                var btnClass = "btn btn_iconT btn_cons dropdown-toggle btn-sm btn-radius";
...
owlBtnSearch.$inject=['btnService'];
     function owlBtnSearch(btnService) {
        return {
            ...
            compile: function (tElement, tAttrs) {
                var btnName = "etcFunc";
                var btnClass = "btn btn_iconT btn_cons dropdown-toggle btn-sm btn-default btn-radius";
