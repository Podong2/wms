...
angular.module('wmsApp').directive('smartTreeviewContent', smartTreeviewContent);
smartTreeviewContent.$inject=['$compile'];
    function smartTreeviewContent($compile) {
    return {
        restrict: 'E',
...
angular.module('wmsApp').directive('smartTreeview', smartTreeview);
smartTreeview.$inject=['$compile', '$sce'];
function smartTreeview($compile, $sce) {
    return {
        restrict: 'A',
        scope: {
            'items': '='
