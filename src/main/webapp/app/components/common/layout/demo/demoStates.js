...
angular.module('wmsApp').directive('demoStates', demoStates);
demoStates.$inject=['$rootScope'];
    function demoStates($rootScope) {
    return {
        restrict: 'EA',
        replace: true,
        templateUrl: 'app/components/common/layout/demo/demo-states.tpl.html',
        scope: true,
        ...
        controller: function ($scope) {
            ...
            localStorage.setItem('sm-fixed-page-footer', false);
            $root.toggleClass('fixed-page-footer', false);
