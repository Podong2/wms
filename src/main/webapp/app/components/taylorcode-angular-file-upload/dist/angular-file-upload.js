		...
		promise.success = function(fn) {
			promise.then(function(response) {
				...
				if (response.data.message != null) {
					if (response.data.message.status == "fail" && response.data.message.message != null) {
						var modalService = $injector.get('modalService');
						var uiConstant = $injector.get('uiConstant');
						modalService.userConfirmModal($filter("translate")("common.responseErrorMessage"),
							response.data.message.message,
							uiConstant.urlType.COMMON_ALERT_MODAL_HTML);
					}
				}
			});
