/**
 * Created by 와이즈스톤 on 2016-07-11.
 */
...
(function() {
    ...
    ganttController.$inject = ['$scope', '$timeout', '$log', 'ganttUtils', 'GanttObjectModel', 'Sample', 'ganttMouseOffset', 'ganttDebounce', 'moment',];
    ...
    function ganttController ($scope, $timeout, $log, utils, ObjectModel, Sample, mouseOffset, debounce, moment) {
        ...
        $scope.options = {
            ...
            labelsEnabled: true,
            currentDate: 'line',
            currentDateValue: new Date(2016, 7, 23, 11, 20, 0),
            draw: false,
            readOnly: false,
    ...
    .service('Sample', function Sample() {
        return {
            getSampleData: function() {
                return [{name: 'Milestones', height: '3em', sortable: false, classes: 'gantt-row-milestone', color: '#45607D', tasks: [
