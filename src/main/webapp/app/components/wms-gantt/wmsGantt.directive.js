...
(function(){
    ...
    angular.module('wmsApp')
        .directive('wmsGantt', wmsGantt);
    wmsGantt.$inject=['$document', '$log', '$compile', 'findUser', '$q']
    function wmsGantt($document, $log, $compile, findUser, $q) {
        ...
        return {
            ...
            replace: false,
            templateUrl : 'app/components/wms-gantt/wmsGanttTemplate.html',
