 ...
 */
@Entity
@Table(name = "owl_social_user_connection")
...
public class SocialUserConnection implements Serializable {
    ...
    @Id
    @GeneratedValue(strategy = GenerationType.TABLE, generator = "socialUserConnectionSeqGenerator")
    @TableGenerator(name = "socialUserConnectionSeqGenerator"
        , table = "owl_sequence"
        , initialValue = 10000
        , pkColumnValue = "owl_social_user_connection_id"
        , pkColumnName = "seq_id"
