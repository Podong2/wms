...
public class HeaderUtil {
    ...
    public static HttpHeaders createAlert(String message, String param) {
        ...
        headers.add("X-wmsApp-alert", message);
        headers.add("X-wmsApp-params", param);
        return headers;
    }

    public static HttpHeaders createEntityCreationAlert(String entityName, String param) {
        return createAlert("wmsApp." + entityName + ".created", param);
    }

    public static HttpHeaders createEntityUpdateAlert(String entityName, String param) {
        return createAlert("wmsApp." + entityName + ".updated", param);
    }
    ...
    public static HttpHeaders createFailureAlert(String entityName, String errorKey, String defaultMessage) {
        ...
        HttpHeaders headers = new HttpHeaders();
        headers.add("X-wmsApp-error", "error." + errorKey);
        headers.add("X-wmsApp-params", entityName);
        return headers;
    }
}
